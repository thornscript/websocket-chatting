...
import dev.poporo.websocketchat.common.constant.JwtConstants;
import dev.poporo.websocketchat.common.log.HttpRequestLogger;
...
public class JwtAuthTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (StringUtils.hasText(resolvedToken) && tokenProvider.isValidToken(resolvedToken)) {
            ...
            HttpRequestLogger.info("Authenticated user: %s, uri: %s"
                    .formatted(authentication.getName(), request.getRequestURI()));
        }
